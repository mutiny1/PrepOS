...
param(
  ...
  [string]$Folder = "$env:temp\edgeinstall" ,
...
start-process "dism" -ArgumentList "/online /Disable-Feature /NoRestart /FeatureName:Internet-Explorer-Optional-amd64"
Write-Output ""
Write-Output "IE Disabled successfully!"
